...
class NavFeaturedPage extends BasePage {
  @override
  _NavFeaturedPageState createState() => _NavFeaturedPageState();
}
...
class _NavFeaturedPageState extends BasePageState<NavFeaturedPage> with BasicPage {
  @override
  Widget body() {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            TextWidget('Featured For You', weight: FontWeight.w600, size: 20.0, padding: const EdgeInsets.only(top: 8.0, left: 24.0)),
            GridView.builder(
