...
import 'package:marier_shoping/drawer/orders/items/order_item.dart';
...
class _OrdersPageState extends BasePageState<OrdersPage> with BasicPage {
  @override
  Widget body() {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            TextWidget('Orders', weight: FontWeight.w600, size: 20.0, padding: const EdgeInsets.only(top: 8.0, bottom: 24.0)),
