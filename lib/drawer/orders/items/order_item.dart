...
class OrderItem extends StatefulWidget {
  ...
  OrderItem({this.url, this.title, this.details, this.price, this.deliveryTime});

  @override
  _OrderItemState createState() => _OrderItemState(url, title, details, price, deliveryTime);
}

class _OrderItemState extends State<OrderItem> {
  _OrderItemState(this.url, this.title, this.details, this.price, this.deliveryTime);
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Flexible(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Padding(padding: EdgeInsets.only(top: 12.0), child: Row(children: [TextWidget('Delivered: ', weight: FontWeight.w600, size: 12.0), TextWidget(deliveryTime, size: 12.0)])),
            ]),
          ),
        ]),
      ),
