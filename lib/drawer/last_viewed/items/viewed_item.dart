...
class ViewedItem extends StatefulWidget {
  final String url;
  final String title;
  ...
  ViewedItem({this.url, this.title, this.details, this.price, this.deliveryTime});

  @override
  _ViewedItemState createState() => _ViewedItemState(url, title, details, price, deliveryTime);
}

class _ViewedItemState extends State<ViewedItem> {
  _ViewedItemState(this.url, this.title, this.details, this.price, this.deliveryTime);
