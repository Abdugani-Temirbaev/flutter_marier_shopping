        ...
        return SingleChildScrollView(
          ...
          child: ConstrainedBox(
            constraints: constraints.copyWith(
              minHeight: constraints.maxHeight - padding.vertical - mediaQuery.padding.bottom,
...
class MinHeightOrUnbounded extends SingleChildRenderObjectWidget {
  ...
  @override
  void updateRenderObject(BuildContext context, RenderMinHeightOrUnbounded renderObject) {
...
class RenderMinHeightOrUnbounded extends RenderProxyBox {
  ...
  @override
  void performLayout() {
    child.layout(constraints.copyWith(minHeight: _minHeight), parentUsesSize: true);
    size = child.size;
  }
}
